...
public class BookControllerUnitTest {
	...
	public void save_테스트() throws Exception {
		// given (테스트를 하기 위한 준비)
		Book book = new Book(null, "스프링 따라하기", "코스","의류","asd","11-11-11","11-11-11","11-11-11","신한","123");
		String content = new ObjectMapper().writeValueAsString(book);
		when(bookService.저장하기(book)).thenReturn(new Book(1L, "스프링 따라하기", "코스","의류","asd","11-11-11","11-11-11","11-11-11","신한","123"));
	...
	public void findAll_테스트() throws Exception {
		...
		books.add(new Book(1L, "스프링부트 따라하기", "코스","의류","asd","11-11-11","11-11-11","11-11-11","신한","123"));
		books.add(new Book(2L, "리엑트 따라하기", "코스","의류","asd","11-11-11","11-11-11","11-11-11","신한","123"));
	...
	public void findById_테스트() throws Exception {
		// given
		Long id = 1L;
		when(bookService.한건가져오기(id)).thenReturn(new Book(1L, "자바 공부하기", "쌀","의류","asd","11-11-11","11-11-11","11-11-11","신한","123"));
	...
	public void update_테스트() throws Exception {
		// given
		Long id = 1L;
		Book book = new Book(null, "C++ 따라하기", "코스","의류","asd","11-11-11","11-11-11","11-11-11","신한","123");
		String content = new ObjectMapper().writeValueAsString(book);

		when(bookService.수정하기(id, book)).thenReturn(new Book(1L, "C++ 따라하기", "코스","의류","asd","11-11-11","11-11-11","11-11-11","신한","123"));
